...
EntityFactory::createBellmiteBoss(GameEngine::ComponentsContainer &container,
    ...
    size_t entityId = createBossMob(
        container,
        bossConfig["spriteSheetPath"].get<std::string>(),
        bossConfig["spriteSheetHeight"].get<int>(),
        bossConfig["spriteSheetWidth"].get<int>(),
        bossConfig["frames"].get<int>(),
        bossConfig["twoDirections"].get<bool>(),
        ...
        bossConfig["deathFrames"].get<int>(),
        pos,
        velocity,
        bossConfig["playerA"].get<int>(),
        bossConfig["scale"].get<float>(),
        bossConfig["rotation"].get<float>(),
        GameEngine::ColorR(
            bossConfig["tint"]["r"].get<int>(),
...
EntityFactory::createBellmitePod(GameEngine::ComponentsContainer &container,
    ...
    size_t entityId = createBossMob(
        container,
        podConfig["spriteSheetPath"].get<std::string>(),
        podConfig["spriteSheetHeight"].get<int>(),
        podConfig["spriteSheetWidth"].get<int>(),
        podConfig["frames"].get<int>(),
        podConfig["twoDirections"].get<bool>(),
        podConfig["reverse"].get<bool>(),
        ...
        podConfig["deathFrames"].get<int>(),
        pos,
        velocity,
        podConfig["playerA"].get<int>(),
        podConfig["scale"].get<float>(),
        podConfig["rotation"].get<float>(),
        GameEngine::ColorR(
            podConfig["tint"]["r"].get<int>(),
            podConfig["tint"]["g"].get<int>(),
            podConfig["tint"]["b"].get<int>(),
            podConfig["tint"]["a"].get<int>()
        ),
