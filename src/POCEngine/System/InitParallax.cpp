...
void InitParallax::update(GameEngine::ComponentsContainer &componentsContainer, GameEngine::EventHandler &eventHandler)
{
    ...
    for (const auto &window : windows) {
        ...
        if (windowOpt.has_value()) {
            ...
            GameEngine::rect rect2(0, 0, windowSize->windowWidth, windowSize->windowHeight);
            GameEngine::Vect2 pos2(0, 0);
            GameEngine::Vect2 pos3(windowSize->windowWidth, 0);
            ...
            auto spritecompoennt2 = std::make_shared<GameEngine::SpriteComponent>("assets/background_1.png", pos2, rect2, 2, scale, rotation, tint);
            ...
            auto spritecompoennt3 = std::make_shared<GameEngine::SpriteComponent>("assets/background_1.png", pos3, rect2, 2, scale, rotation, tint);
