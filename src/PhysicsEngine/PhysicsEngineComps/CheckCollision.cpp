...
bool classCheckCollision::checkCollision(const GameEngine::Circle& a, const GameEngine::Circle& b)
{
...
bool classCheckCollision::checkCollision(const GameEngine::rect& r, const GameEngine::Circle& c)
{
    float rLeft = r.x;
...
bool classCheckCollision::checkCollision(const GameEngine::rect& a, const GameEngine::rect& b)
{
    float aLeft = a.x;
